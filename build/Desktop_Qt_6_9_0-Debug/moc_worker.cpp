...
template <> constexpr inline auto Worker::qt_create_metaobjectdata<qt_meta_tag_ZN6WorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'database_data'
        QtMocHelpers::SignalData<void(QVariantList)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'dowork'
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(bool )>(_a, &Worker::connection_status, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(QVariantList )>(_a, &Worker::database_data, 1))
            return;
    }
}
...
// SIGNAL 0
void Worker::connection_status(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Worker::database_data(QVariantList _t1)
{
